...
+
기획 센터가 표시되어 있습니다. 계획 센터에서 VM 인벤토리 데이터를 업로드하고, 이전에 업로드한 인벤토리 데이터를 확인하고, VM 인벤토리 데이터 세트를 사용하여 마이그레이션을 계획할 수 있습니다.
...
에서 https://www.dell.com/en-us/shop/vmware/sl/rvtools["RVTools에 대해 자세히 알아보십시오"^]
...
+
"명령줄 매개변수"에 대한 장을 참조하세요. https://www.dell.com/en-us/shop/vmware/sl/rvtools["리소스 섹션에 있는 RVTools 설명서"^] 자세한 내용은.
...
* link:launch-migration-advisor-gcve.html["Google Cloud VMware Engine 배포 계획 생성"]
